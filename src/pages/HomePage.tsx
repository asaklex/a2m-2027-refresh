  ...
  <section className="a2m-reveal py-14 lg:py-16">
    <div className="mx-auto w-full max-w-[1280px] px-4 sm:px-8 lg:px-16">
      <div className="flex flex-wrap items-end justify-between gap-4">
        ...
        <Link className="group inline-flex shrink-0 items-center gap-1.5 font-semibold transition-colors text-emerald-cta hover:text-emerald-deep" to="/en/about#advisory-board">
