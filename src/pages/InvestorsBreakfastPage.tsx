...
export default function InvestorsBreakfastPage() {
  ...
  <div className="mx-auto w-full max-w-[max(1280px,80vw)] px-4 sm:px-8 lg:px-16">
    <div className="flex flex-col gap-16 py-14 lg:gap-20 lg:py-20">
      <section id="breakfast-overview" className="a2m-reveal scroll-mt-[190px]">
        <div className="grid grid-cols-1 gap-10 lg:grid-cols-12 lg:gap-14">
          ...
          <div className="relative self-start lg:col-span-5">
            <div aria-hidden="true" className="absolute -right-3 -top-3 hidden h-full w-full rounded-sm border-2 border-gold/50 lg:block" />
            <div className="a2m-motif relative overflow-hidden rounded-sm border border-ivory/15 bg-emerald-deep text-ivory shadow-emerald">
              <div className="relative z-10 p-6 sm:p-7">
                ...
                <p className="mt-6 font-semibold text-[11px] text-gold uppercase tracking-[0.18em]">
      ...
      <section id="why-this-program" className="a2m-reveal scroll-mt-[190px]">
        ...
        <div className="mt-8 grid grid-cols-1 gap-10 lg:grid-cols-12 lg:gap-14">
          ...
          <div className="lg:col-span-5">
            <p className="border-gold border-l-2 pl-5 font-medium text-[1.2rem] text-ink [font-family:var(--font-display)] leading-[1.45] sm:text-[1.3rem]">
              The co-investments that get structured in the Capital Markets Lounge start in this room.
            </p>
          </div>
        </div>
      </section>
      <section id="who-should-attend" className="a2m-reveal scroll-mt-[190px]">
        <div className="flex items-center gap-5">
          <h2 className="font-display font-bold tracking-[-0.01em] text-h2">
            Who Should Attend
          </h2>
        ...
        <div className="mt-8 grid grid-cols-1 gap-5 sm:grid-cols-2 lg:grid-cols-3">
          {audiences.map((audience) => (
            <article key={audience.index} className="group flex h-full flex-col rounded-sm border border-hairline bg-card p-6 shadow-card transition-all duration-[250ms] ease-discret hover:-translate-y-1 hover:border-gold hover:shadow-card-hover">
      ...
      <section id="pre-screened-projects" className="a2m-reveal scroll-mt-[190px]">
        <div className="flex items-center gap-5">
          <h2 className="font-display font-bold tracking-[-0.01em] text-h2">
        ...
        <div className="mt-8 grid grid-cols-1 gap-5 sm:grid-cols-2 lg:grid-cols-4">
          {projects.map((project) => (
            <article key={project.index} className="group flex h-full flex-col rounded-sm border border-hairline bg-card p-6 shadow-card transition-all duration-[250ms] ease-discret hover:-translate-y-1 hover:border-gold hover:shadow-card-hover">
              <div className="flex items-center gap-3">
                <span aria-hidden="true" className="tnum font-display font-bold text-[1.4rem] leading-none text-gold">
                  {project.index}
                </span>
