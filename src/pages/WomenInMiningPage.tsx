...
export default function WomenInMiningPage() {
  ...
  <div className="a2m-motif relative overflow-hidden border-hairline border-b bg-emerald-deep text-ivory">
    <img alt="" aria-hidden="true" decoding="async" data-nimg="fill" className="object-cover" style={{ position: 'absolute', height: '100%', width: '100%', left: '0', top: '0', right: '0', bottom: '0', color: 'transparent' }} sizes="100vw" srcSet="/images/news/women-in-mining-programme.jpg 640w, /images/news/women-in-mining-programme.jpg 750w, /images/news/women-in-mining-programme.jpg 828w, /images/news/women-in-mining-programme.jpg 1080w, /images/news/women-in-mining-programme.jpg 1200w, /images/news/women-in-mining-programme.jpg 1920w, /images/news/women-in-mining-programme.jpg 2048w, /images/news/women-in-mining-programme.jpg 3840w" src="/images/news/women-in-mining-programme.jpg" />
          ...
          <div className="grid grid-cols-2 gap-4 sm:grid-cols-4">
            <div className="rounded-sm border border-hairline bg-card p-5 shadow-card">
              ...
              <span className="mt-1 block text-small text-muted">
                of the mining workforce are women
              </span>
            </div>
            <div className="rounded-sm border border-hairline bg-card p-5 shadow-card">
              <span className="tnum block font-display font-bold text-data-xl text-emerald-deep">
              ...
              <span className="mt-1 block text-small text-muted">
                in artisanal & small-scale mining
              </span>
            </div>
          </div>
          <h3 className="max-w-[760px] font-display font-semibold text-h3 text-ink">
            ...
            <div className="h-full">
              <div className="rounded-sm border transition-all duration-[250ms] ease-discret border-hairline bg-card shadow-card hover:-translate-y-1 hover:border-gold hover:shadow-card-hover flex h-full flex-col gap-3 p-6">
                ...
                <p className="text-body text-muted">
                  Real stories from women leading mines, financial institutions, and government mining bodies across Canada and Africa.
                </p>
              </div>
            </div>
            <div className="h-full">
              <div className="rounded-sm border transition-all duration-[250ms] ease-discret border-hairline bg-card shadow-card hover:-translate-y-1 hover:border-gold hover:shadow-card-hover flex h-full flex-col gap-3 p-6">
                ...
                <p className="text-body text-muted">
                  Challenges and practical solutions for increasing women's participation in traditionally male-dominated sectors.
                </p>
              </div>
            </div>
            <div className="h-full">
              <div className="rounded-sm border transition-all duration-[250ms] ease-discret border-hairline bg-card shadow-card hover:-translate-y-1 hover:border-gold hover:shadow-card-hover flex h-full flex-col gap-3 p-6">
                ...
                <p className="text-body text-muted">
                  The pivotal role of women in responsible mining practices and sustainable community development.
                </p>
              </div>
            </div>
            <div className="h-full">
              <div className="rounded-sm border transition-all duration-[250ms] ease-discret border-hairline bg-card shadow-card hover:-translate-y-1 hover:border-gold hover:shadow-card-hover flex h-full flex-col gap-3 p-6">
                ...
                <p className="text-body text-muted">
                  Strategic connections with peers, decision-makers, and potential mentors.
                </p>
              </div>
            </div>
          </div>
