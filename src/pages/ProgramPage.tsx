      ...
      <div className="mt-8">
        <div className="flex flex-col gap-6">
          <p className="max-w-[760px] text-lead text-muted">
            Six signature experiences make up A2M 2027 — each engineered for a precise outcome, from ministerial dialogue to deal-making meetings.
          </p>
          <div className="flex flex-col gap-8">
            <div className="grid grid-cols-1 gap-x-8 gap-y-7 sm:grid-cols-2 lg:grid-cols-3">
              <Link className="group/icr block" to="/en/program/ministerial-roundtable">
                <div className="flex items-start gap-4">
                  ...
                  <div className="pt-1">
                    ...
                    <p className="mt-1 text-muted text-small">
                      The closed-door political dialogue on June 6.
                    </p>
                  </div>
                </div>
              </Link>
              <Link className="group/icr block" to="/en/program/honorary-country">
                <div className="flex items-start gap-4">
                  <span className="inline-flex size-14 shrink-0 items-center justify-center rounded-full border border-gold/30 bg-mist text-emerald-cta transition-colors group-hover/icr:border-gold group-hover/icr:bg-gold/15">
                    <svg viewBox="0 0 24 24" aria-hidden="true" focusable="false" className="size-6">
                      <g fill="none" stroke="currentColor" strokeWidth="1.5">
                  ...
                  <div className="pt-1">
                    ...
                    <p className="mt-1 text-muted text-small">
                      Côte d'Ivoire, the 2027 edition's showcase.
                    </p>
                  </div>
                </div>
              </Link>
              <Link className="group/icr block" to="/en/program/women-in-mining">
                <div className="flex items-start gap-4">
                  <span className="inline-flex size-14 shrink-0 items-center justify-center rounded-full border border-gold/30 bg-mist text-emerald-cta transition-colors group-hover/icr:border-gold group-hover/icr:bg-gold/15">
                    <svg viewBox="0 0 24 24" aria-hidden="true" focusable="false" className="size-6">
                      <g fill="none" stroke="currentColor" strokeWidth="1.5">
                  ...
                  <div className="pt-1">
                    ...
                    <p className="mt-1 text-muted text-small">
                      Women's leadership, from site to boardroom.
                    </p>
                  </div>
                </div>
              </Link>
              <Link className="group/icr block" to="/en/program/investors-breakfast">
                <div className="flex items-start gap-4">
                  <span className="inline-flex size-14 shrink-0 items-center justify-center rounded-full border border-gold/30 bg-mist text-emerald-cta transition-colors group-hover/icr:border-gold group-hover/icr:bg-gold/15">
                    <svg viewBox="0 0 24 24" aria-hidden="true" focusable="false" className="size-6">
                      <g fill="none" stroke="currentColor" strokeWidth="1.5">
                  ...
                  <div className="pt-1">
                    ...
                    <p className="mt-1 text-muted text-small">
                      90 closed-door minutes, capital side only.
                    </p>
                  </div>
                </div>
              </Link>
              <Link className="group/icr block" to="/en/program#matchmaking">
                <div className="flex items-start gap-4">
                  <span className="inline-flex size-14 shrink-0 items-center justify-center rounded-full border border-gold/30 bg-mist text-emerald-cta transition-colors group-hover/icr:border-gold group-hover/icr:bg-gold/15">
                    <svg viewBox="0 0 24 24" aria-hidden="true" focusable="false" className="size-6">
                  ...
                  <div className="pt-1">
                    ...
                    <p className="mt-1 text-muted text-small">
                      Your B2B agenda confirmed before you land.
                    </p>
                  </div>
                </div>
              </Link>
              <Link className="group/icr block" to="/en/program/networking">
                <div className="flex items-start gap-4">
                  <span className="inline-flex size-14 shrink-0 items-center justify-center rounded-full border border-gold/30 bg-mist text-emerald-cta transition-colors group-hover/icr:border-gold group-hover/icr:bg-gold/15">
                    <svg viewBox="0 0 24 24" aria-hidden="true" focusable="false" className="size-6">
                      <g fill="none">
                  ...
                  <div className="pt-1">
                    ...
                    <p className="mt-1 text-muted text-small">
                      Reception, gala and evenings where deals close.
                    </p>
                  </div>
                </div>
              </Link>
