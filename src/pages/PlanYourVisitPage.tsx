      ...
      <div className="mt-8">
        <div className="flex flex-col gap-10">
          ...
          <div className="grid grid-cols-1 gap-5 sm:grid-cols-2 lg:grid-cols-4">
            <div className="rounded-sm transition-all duration-[250ms] ease-discret border-2 border-gold bg-card shadow-card flex flex-col gap-3 p-6">
              ...
              <span className="tnum font-bold font-display text-data-xl text-emerald-deep">
                1 050 $
              </span>
              <span className="text-[12px] text-subtle uppercase tracking-[0.1em]">
                Sep 1 – Dec 31, 2026
              </span>
            </div>
            <div className="rounded-sm border transition-all duration-[250ms] ease-discret border-hairline bg-card shadow-card flex flex-col gap-3 p-6">
              <div className="flex items-center justify-between gap-2">
                <span className="font-semibold text-[11px] text-copper uppercase tracking-[0.14em]">
                  Early Bird 2
                </span>
        ...
        <div className="flex flex-col gap-6">
          ...
          <div className="flex flex-col gap-8">
            ...
            <div className="grid gap-4 grid-cols-1">
              <figure className="flex flex-col gap-1.5">
                <div style={{ aspectRatio: '16 / 9' }} className="relative overflow-hidden rounded-sm border border-hairline bg-surface w-full">
                  <img alt="Façade of the Fairmont The Queen Elizabeth in Montréal" loading="lazy" decoding="async" data-nimg="fill" className="object-cover" style={{ position: 'absolute', height: '100%', width: '100%', left: '0', top: '0', right: '0', bottom: '0', color: 'transparent' }} sizes="(min-width: 1024px) 33vw, (min-width: 640px) 50vw, 100vw" srcSet="/images/plan/fairmont.jpg 256w, /images/plan/fairmont.jpg 384w, /images/plan/fairmont.jpg 640w, /images/plan/fairmont.jpg 750w, /images/plan/fairmont.jpg 828w, /images/plan/fairmont.jpg 1080w, /images/plan/fairmont.jpg 1200w, /images/plan/fairmont.jpg 1920w, /images/plan/fairmont.jpg 2048w, /images/plan/fairmont.jpg 3840w" src="/images/plan/fairmont.jpg" />
                </div>
            ...
            <div className="grid gap-4 grid-cols-1 sm:grid-cols-2">
              <figure className="flex flex-col gap-1.5">
                <div style={{ aspectRatio: '3 / 2' }} className="relative overflow-hidden rounded-sm border border-hairline bg-surface w-full">
                  <img alt="Daytime facade of the hotel and a contemporary walnut-and-ivory guest room (illustrative)" loading="lazy" decoding="async" data-nimg="fill" className="object-cover" style={{ position: 'absolute', height: '100%', width: '100%', left: '0', top: '0', right: '0', bottom: '0', color: 'transparent' }} sizes="(min-width: 1024px) 33vw, (min-width: 640px) 50vw, 100vw" srcSet="/images/plan/fairmont-day.jpg 256w, /images/plan/fairmont-day.jpg 384w, /images/plan/fairmont-day.jpg 640w, /images/plan/fairmont-day.jpg 750w, /images/plan/fairmont-day.jpg 828w, /images/plan/fairmont-day.jpg 1080w, /images/plan/fairmont-day.jpg 1200w, /images/plan/fairmont-day.jpg 1920w, /images/plan/fairmont-day.jpg 2048w, /images/plan/fairmont-day.jpg 3840w" src="/images/plan/fairmont-day.jpg" />
                </div>
                <figcaption className="text-[11px] text-subtle">
              ...
              <figure className="flex flex-col gap-1.5">
                <div style={{ aspectRatio: '3 / 2' }} className="relative overflow-hidden rounded-sm border border-hairline bg-surface w-full">
                  <img alt="Daytime facade of the hotel and a contemporary walnut-and-ivory guest room (illustrative)" loading="lazy" decoding="async" data-nimg="fill" className="object-cover" style={{ position: 'absolute', height: '100%', width: '100%', left: '0', top: '0', right: '0', bottom: '0', color: 'transparent' }} sizes="(min-width: 1024px) 33vw, (min-width: 640px) 50vw, 100vw" srcSet="/images/plan/fairmont-room.jpg 256w, /images/plan/fairmont-room.jpg 384w, /images/plan/fairmont-room.jpg 640w, /images/plan/fairmont-room.jpg 750w, /images/plan/fairmont-room.jpg 828w, /images/plan/fairmont-room.jpg 1080w, /images/plan/fairmont-room.jpg 1200w, /images/plan/fairmont-room.jpg 1920w, /images/plan/fairmont-room.jpg 2048w, /images/plan/fairmont-room.jpg 3840w" src="/images/plan/fairmont-room.jpg" />
                </div>
                <figcaption className="text-[11px] text-subtle">
                  <a href="https://commons.wikimedia.org/wiki/File:The_Queen_Elizabeth.jpg" target="_blank" rel="noopener noreferrer" className="underline-offset-2 transition-colors hover:text-muted hover:underline">
                    Photo de jour : Jeangagnon — Wikimedia Commons
      ...
      <div className="mt-8">
        <div className="flex flex-col gap-6">
          ...
          <div className="flex flex-col gap-8">
            ...
            <div className="grid gap-4 grid-cols-1">
              <figure className="flex flex-col gap-1.5">
                <div style={{ aspectRatio: '21 / 9' }} className="relative overflow-hidden rounded-sm border border-hairline bg-surface w-full">
                  <img alt="Flower-lined Place Jacques-Cartier before Montréal City Hall in summer" loading="lazy" decoding="async" data-nimg="fill" className="object-cover" style={{ position: 'absolute', height: '100%', width: '100%', left: '0', top: '0', right: '0', bottom: '0', color: 'transparent' }} sizes="(min-width: 1024px) 33vw, (min-width: 640px) 50vw, 100vw" srcSet="/images/plan/vieux-montreal.jpg 256w, /images/plan/vieux-montreal.jpg 384w, /images/plan/vieux-montreal.jpg 640w, /images/plan/vieux-montreal.jpg 750w, /images/plan/vieux-montreal.jpg 828w, /images/plan/vieux-montreal.jpg 1080w, /images/plan/vieux-montreal.jpg 1200w, /images/plan/vieux-montreal.jpg 1920w, /images/plan/vieux-montreal.jpg 2048w, /images/plan/vieux-montreal.jpg 3840w" src="/images/plan/vieux-montreal.jpg" />
                </div>
                <figcaption className="text-[11px] text-subtle">
                  <a href="https://commons.wikimedia.org/wiki/File:Montreal_DSC04520_(22221499769).jpg" target="_blank" rel="noopener noreferrer" className="underline-offset-2 transition-colors hover:text-muted hover:underline">
            ...
            <div className="grid gap-4 grid-cols-1 sm:grid-cols-2">
              <div style={{ aspectRatio: '16 / 9' }} className="relative overflow-hidden rounded-sm border border-hairline bg-surface w-full">
                <img alt="Montréal festival scene and Jean-Talon Market stalls" loading="lazy" decoding="async" data-nimg="fill" className="object-cover" style={{ position: 'absolute', height: '100%', width: '100%', left: '0', top: '0', right: '0', bottom: '0', color: 'transparent' }} sizes="(min-width: 1024px) 33vw, (min-width: 640px) 50vw, 100vw" srcSet="/images/plan/festival.jpg 256w, /images/plan/festival.jpg 384w, /images/plan/festival.jpg 640w, /images/plan/festival.jpg 750w, /images/plan/festival.jpg 828w, /images/plan/festival.jpg 1080w, /images/plan/festival.jpg 1200w, /images/plan/festival.jpg 1920w, /images/plan/festival.jpg 2048w, /images/plan/festival.jpg 3840w" src="/images/plan/festival.jpg" />
              </div>
              <div style={{ aspectRatio: '16 / 9' }} className="relative overflow-hidden rounded-sm border border-hairline bg-surface w-full">
                <img alt="Montréal festival scene and Jean-Talon Market stalls" loading="lazy" decoding="async" data-nimg="fill" className="object-cover" style={{ position: 'absolute', height: '100%', width: '100%', left: '0', top: '0', right: '0', bottom: '0', color: 'transparent' }} sizes="(min-width: 1024px) 33vw, (min-width: 640px) 50vw, 100vw" srcSet="/images/plan/market.jpg 256w, /images/plan/market.jpg 384w, /images/plan/market.jpg 640w, /images/plan/market.jpg 750w, /images/plan/market.jpg 828w, /images/plan/market.jpg 1080w, /images/plan/market.jpg 1200w, /images/plan/market.jpg 1920w, /images/plan/market.jpg 2048w, /images/plan/market.jpg 3840w" src="/images/plan/market.jpg" />
              </div>
            </div>
          </div>
        </div>
        ...
        <div className="flex flex-col gap-6">
          ...
          <div className="flex flex-col gap-8">
            ...
            <div className="grid gap-4 grid-cols-1">
              <figure className="flex flex-col gap-1.5">
                <div style={{ aspectRatio: '16 / 9' }} className="relative overflow-hidden rounded-sm border border-hairline bg-surface w-full">
                  <img alt="Downtown Montréal at golden hour, seen from the Kondiaronk Belvedere" loading="lazy" decoding="async" data-nimg="fill" className="object-cover" style={{ position: 'absolute', height: '100%', width: '100%', left: '0', top: '0', right: '0', bottom: '0', color: 'transparent' }} sizes="(min-width: 1024px) 33vw, (min-width: 640px) 50vw, 100vw" srcSet="/images/plan/belvedere-skyline.jpg 256w, /images/plan/belvedere-skyline.jpg 384w, /images/plan/belvedere-skyline.jpg 640w, /images/plan/belvedere-skyline.jpg 750w, /images/plan/belvedere-skyline.jpg 828w, /images/plan/belvedere-skyline.jpg 1080w, /images/plan/belvedere-skyline.jpg 1200w, /images/plan/belvedere-skyline.jpg 1920w, /images/plan/belvedere-skyline.jpg 2048w, /images/plan/belvedere-skyline.jpg 3840w" src="/images/plan/belvedere-skyline.jpg" />
                </div>
                <figcaption className="text-[11px] text-subtle">
                  <a href="https://commons.wikimedia.org/wiki/File:Skyscrapers_@_Sunset_@_Belv%C3%A9d%C3%A8re_@_View_from_Chalet_du_Mont_Royal_@_Mount_Royal_@_Montreal_(29793970813).jpg" target="_blank" rel="noopener noreferrer" className="underline-offset-2 transition-colors hover:text-muted hover:underline">
                    Guilhem Vellut — Wikimedia Commons
                    · CC BY 2.0
                  </a>
                </figcaption>
